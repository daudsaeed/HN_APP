...
class _$News extends News {
  ...
  _$News._(
    ...
    BuiltValueNullFieldError.checkNotNull(type, r'News', 'type');
    BuiltValueNullFieldError.checkNotNull(by, r'News', 'by');
    BuiltValueNullFieldError.checkNotNull(time, r'News', 'time');
  }
    ...
    try {
      _$result = _$v ??
          new _$News._(
              ...
              type:
                  BuiltValueNullFieldError.checkNotNull(type, r'News', 'type'),
              by: BuiltValueNullFieldError.checkNotNull(by, r'News', 'by'),
              time:
                  BuiltValueNullFieldError.checkNotNull(time, r'News', 'time'),
              text: text,
              dead: dead,
